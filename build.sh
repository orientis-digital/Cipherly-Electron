#!/usr/bin/env bash
# ==============================================================================
# Cipherly All-in-One Build & Version Management Script
...
echo -e "${BOLD}${CYAN}"
echo "   ____ _____ ____  _   _ _____ ____  _     __   __"
echo "  / ___|_   _|  _ \| | | | ____|  _ \| |    \ \ / /"
echo " | |     | | | |_) | |_| |  _| | |_) | |     \ V / "
echo " | |___  | | |  __/|  _  | |___|  _ <| |___   | |  "
echo "  \____| |_| |_|   |_| |_|_____|_| \_\_____|  |_|  "
echo " Cipherly Encryption Suite Build Automation"
echo " Developed by Orientis Digital"
echo -e "${NC}"
...
echo -e "\n${GREEN}${BOLD}✓ Cipherly v${CURRENT_VERSION} build pipeline completed flawlessly!${NC}\n"
